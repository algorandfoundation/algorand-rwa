...
from queries.stablecoins.queries import HOLDERS, MARKET_CAP, VOLUME, ACTIVE_WALLETS
from charts.stablecoins.charts import create_mcap_chart, create_volume_chart, create_mau_chart
...
def render():
    ...
    mcap = mcap_df.iloc[-1]['total_circulating_supply']
    mcap_delta = mcap/mcap_df.iloc[-2]['total_circulating_supply'] - 1
    ...
    last30d_vol = vol_df[-30:]['total_stablecoin_volume'].sum()
    vol_delta = last30d_vol/vol_df[-60:-30]['total_stablecoin_volume'].sum() - 1
